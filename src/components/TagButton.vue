<template>
  <div class="flex flex-wrap gap-2">
    ...
    >
      ...
      <span>{{ tag.name }}</span>
      <Icon @click.stop="removeTag(index)" icon="mdi:close" color="black" width="18" class="ml-2" />
    </button>

    <button class="flex px-3 py-1 rounded-full text-sm font-medium transition-colors text-white bg-black hover:dark:bg-gray-800">
      Agregar
